        ...
        <div className="help-modal" onClick={() => setShowHelp(false)}>
          <div className="help-content" onClick={(e) => e.stopPropagation()}>
            ...
            <ul>
              ...
              <li>
                <strong> モード選択について:</strong> <br />
                【自動(AI音声追従)】はマイクを利用してあなたの速度に合わせます。<br />
                【自動一定スクロール】は話すスピードとは無関係に、一定速度で流れます（話すのが苦手な方におすすめです）。<br />
                <span style={{ fontSize: '0.9em', color: '#555' }}>
                  ※ 速度の目安: [ゆっくり]＝約200文字/分、[普通]＝約300文字/分、[早め]＝約450文字/分
                </span>
              </li>
